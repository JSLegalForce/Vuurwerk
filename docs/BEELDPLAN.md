...
Versie 0.9.2 (herbouw compacte cursus) · juridische peildatum 23 september 2026 · bijgewerkt 23 september 2026.
...
Beelden die nu al in de cursus staan, hebben status **CONTROLEREN**: ze moeten nog tegen `BEELDSTIJL.md` worden gecontroleerd. Een beeld wordt pas geplaatst of vervangen als het **GOEDGEKEURD** is.
...
| **01-05** `01-05-categorie-f4.webp` (3 productbeelden) | H1 p5 · F4 en professioneel vuurwerk | herkennen | `cat-f4-*.webp` | CONTROLEREN |
...
**01-06 · Etiket en verpakking** — Close-up van de zijkant van een doos consumentenvuurwerk: `F2`, `Geschikt voor particulier gebruik`, `CE`, `NEM`, minimumleeftijd en een regel gebruiksaanwijzing (onleesbaar mag). Functie: laten zien wat de boa letterlijk overneemt.
...
**04-06 · Inbeslagneming** — Boa neemt twee gesloten dozen met `F2` aan en geeft een formulier (bewijs van ontvangst). Collega noteert. Functie: beslag + kennisgeving.
